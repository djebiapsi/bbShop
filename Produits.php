<?php
  ...
  /**
   * Récupération de tous les produits de la bdd en tableau
   */
  ...
  if ($firstborn+3 > $lengthP - 1) {
    $lastborn = $lengthP - 1;
  }else {
    $lastborn = $firstborn+3;
  }
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" style="padding: 10px 0px;">Espace memebre</a><div class="u-nav-popup"><ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-5"><?php
  if (isset($_SESSION["auth"])) {
...
?></ul>
    ...
    <section class="u-align-center u-clearfix u-image u-section-1" id="sec-e9e8" data-image-width="1200" data-image-height="800">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1"><!--products--><!--products_options_json--><!--{"type":"Recent","source":"","tags":"","count":""}--><!--/products_options_json-->
        <div class="u-expanded-width u-products u-products-1">
          <div class='u-repeater u-repeater-1'>
            <?php
            /**
             * Boucle d'affichage de produit
             */
            for ($i=$firstborn; $i <= $lastborn; $i++) { 
              echo "<!--product_item--><div class='u-align-center u-container-style u-products-item u-repeater-item'>
                <div class='u-container-layout u-similar-container u-container-layout-1'><!--product_image-->
                  <img alt='' class='u-expanded-width u-image u-image-default u-product-control u-image-1' src='$path[$i]' data-image-width='1200' data-image-height='1200'><!--/product_image--><!--product_title-->
                  <h4 class='u-align-center u-product-control u-text u-text-1' data-animation-name='slideIn' data-animation-duration='1000' data-animation-delay='0' data-animation-direction='Down'>
                    <a class='u-product-title-link' href='#'><!--product_title_content-->$refProduit[$i]<!--/product_title_content--></a>
                  </h4><!--/product_title--><!--product_price--'
                  <div class='u-product-control u-product-price u-product-price-1' data-animation-name='zoomIn' data-animation-duration='1000' data-animation-delay='0' data-animation-direction='>
                    <div class='u-price-wrapper u-spacing-10'><!--product_old_price-->
                      <div class='u-price u-text-palette-2-base' style='font-size: 1.25rem; font-weight: 700;'><!--product_regular_price_content-->$prix[$i]€<!--/product_regular_price_content--></div><!--/product_regular_price-->
                    
                  
                  <a href='Details-produit.php?idP=$idP[$i]' data-page-id='281211040' class='u-custom-color-3 u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius-6 u-btn-1'>Réserver</a>
        ...
        <?php
            ...
            /**
             * condition pour bouton page suivante/précédante
             */

            if (isset($idP[$lastborn+1])) {

              $page++;
              echo"<a href='Produits.php?page=$page' data-page-id='281211040' style='margin-bottom: 30px' class='u-black u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius-6 u-btn-1'>Page suivante</a>";

            }
            if (isset($idP[$firstborn-1])) {

              $page--;
              echo"<a href='Produits.php?page=$page' data-page-id='281211040' style='margin-bottom: 30px' class='u-black u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius-6 u-btn-1'>Page précédante</a>";
